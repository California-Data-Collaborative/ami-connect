CREATE TABLE METERSENSE_ACCOUNT_SERVICES_BASE (
...
CREATE TABLE METERSENSE_LOCATIONS_BASE (
    ORG_ID VARCHAR(16777216) NOT NULL,
    CREATED_TIME TIMESTAMP_TZ(9) NOT NULL,
    LOCATION_NO VARCHAR(16777216),
...
CREATE TABLE METERSENSE_METERS_BASE (
    ORG_ID VARCHAR(16777216) NOT NULL,
    CREATED_TIME TIMESTAMP_TZ(9) NOT NULL,
...
CREATE TABLE METERSENSE_METERS_VIEW_BASE (
    ORG_ID VARCHAR(16777216) NOT NULL,
    CREATED_TIME TIMESTAMP_TZ(9) NOT NULL,
    METER_ID VARCHAR(16777216),
    ALT_METER_ID VARCHAR(16777216),
...
CREATE TABLE METERSENSE_METER_LOCATION_XREF_BASE (
    ORG_ID VARCHAR(16777216) NOT NULL,
    CREATED_TIME TIMESTAMP_TZ(9) NOT NULL,
    METER_ID VARCHAR(16777216),
    ACTIVE_DT VARCHAR(16777216),
...
CREATE TABLE METERSENSE_INTERVALREADS_BASE (
    ORG_ID VARCHAR(16777216) NOT NULL,
    CREATED_TIME TIMESTAMP_TZ(9) NOT NULL,
    METER_ID VARCHAR(16777216),
...
CREATE TABLE METERSENSE_REGISTERREADS_BASE (
    ORG_ID VARCHAR(16777216) NOT NULL,
    CREATED_TIME TIMESTAMP_TZ(9) NOT NULL,
    METER_ID VARCHAR(16777216),
    CHANNEL_ID VARCHAR(16777216),
