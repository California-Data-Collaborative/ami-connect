...
from amiadapters.sentryx import SentryxAdapter, SentryxMeter, SentryxMeterRead, SentryxMeterWithReads
...
class TestSentryxAdapter(TestCase):
    ...
    def test_transform_meters_and_reads(self):
        ...
        expected_reads = [
            GeneralMeterRead(meter_id="1", account_id="101", location_id=None, flowtime=datetime.datetime(2024, 7, 7, 1, 0), raw_value=116233.61, raw_unit="CF"),
            GeneralMeterRead(meter_id="2", account_id=None, location_id=None, flowtime=datetime.datetime(2024, 7, 7, 1, 0), raw_value=11, raw_unit="CF")
        ]
